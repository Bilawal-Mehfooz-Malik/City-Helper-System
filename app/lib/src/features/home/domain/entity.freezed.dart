...
@override @useResult
$Res call({
 EntityId id, CategoryId categoryId, SubCategoryId subCategoryId, String coverImageUrl, String name, String cityName, String sectorName,@_latLngJsonConverter LatLng latLng, double avgRating, int totalReviews, bool isPopular, List<OpeningHours>? openingHours, OperationalStatus? entityStatus, ApprovalStatus status,@_timestampJsonConverter DateTime createdAt, EntityType type, double pricing, bool? isFurnished, GenderPreference? genderPref, ListingType listingType
});
