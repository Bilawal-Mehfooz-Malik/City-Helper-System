...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,categoryId,subCategoryId,coverImageUrl,name,cityName,sectorName,latLng,avgRating,totalReviews,isPopular,const DeepCollectionEquality().hash(_openingHours),entityStatus,status,createdAt,type,pricing,isFurnished,genderPref,listingType,timezone,isOpen,const DeepCollectionEquality().hash(_scheduledTaskNames),ownerId,description,const DeepCollectionEquality().hash(_galleryImageUrls),streetAddress,const DeepCollectionEquality().hash(_ratingBreakdown),phoneNumber,messagingNumber,updatedAt,websiteUrl,instagramUrl,facebookUrl,email]);
