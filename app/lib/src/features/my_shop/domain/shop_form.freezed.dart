...
// Step 1: Basic Details
 ...
 Map<DayOfWeek, OpeningHours> get openingHours; double? get pricing; bool get isFurnished; GenderPreference get genderPref; String get timezone; bool get isOpen; Map<String, String> get scheduledTaskNames;// Step 5: Media Uploads
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ShopForm&&(identical(other.category, category) || other.category == category)&&(identical(other.subCategory, subCategory) || other.subCategory == subCategory)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.cityName, cityName) || other.cityName == cityName)&&(identical(other.sectorName, sectorName) || other.sectorName == sectorName)&&(identical(other.streetAddress, streetAddress) || other.streetAddress == streetAddress)&&(identical(other.latLng, latLng) || other.latLng == latLng)&&(identical(other.phoneNumber, phoneNumber) || other.phoneNumber == phoneNumber)&&(identical(other.messagingNumber, messagingNumber) || other.messagingNumber == messagingNumber)&&(identical(other.email, email) || other.email == email)&&(identical(other.facebookUrl, facebookUrl) || other.facebookUrl == facebookUrl)&&(identical(other.instagramUrl, instagramUrl) || other.instagramUrl == instagramUrl)&&(identical(other.websiteUrl, websiteUrl) || other.websiteUrl == websiteUrl)&&const DeepCollectionEquality().equals(other.openingHours, openingHours)&&(identical(other.pricing, pricing) || other.pricing == pricing)&&(identical(other.isFurnished, isFurnished) || other.isFurnished == isFurnished)&&(identical(other.genderPref, genderPref) || other.genderPref == genderPref)&&(identical(other.timezone, timezone) || other.timezone == timezone)&&(identical(other.isOpen, isOpen) || other.isOpen == isOpen)&&const DeepCollectionEquality().equals(other.scheduledTaskNames, scheduledTaskNames)&&const DeepCollectionEquality().equals(other.coverImageBytes, coverImageBytes)&&const DeepCollectionEquality().equals(other.galleryImageBytes, galleryImageBytes)&&const DeepCollectionEquality().equals(other.galleryUrlsToDelete, galleryUrlsToDelete));
}


@override
int get hashCode => Object.hashAll([runtimeType,category,subCategory,name,description,cityName,sectorName,streetAddress,latLng,phoneNumber,messagingNumber,email,facebookUrl,instagramUrl,websiteUrl,const DeepCollectionEquality().hash(openingHours),pricing,isFurnished,genderPref,timezone,isOpen,const DeepCollectionEquality().hash(scheduledTaskNames),const DeepCollectionEquality().hash(coverImageBytes),const DeepCollectionEquality().hash(galleryImageBytes),const DeepCollectionEquality().hash(galleryUrlsToDelete)]);

@override
String toString() {
  return 'ShopForm(category: $category, subCategory: $subCategory, name: $name, description: $description, cityName: $cityName, sectorName: $sectorName, streetAddress: $streetAddress, latLng: $latLng, phoneNumber: $phoneNumber, messagingNumber: $messagingNumber, email: $email, facebookUrl: $facebookUrl, instagramUrl: $instagramUrl, websiteUrl: $websiteUrl, openingHours: $openingHours, pricing: $pricing, isFurnished: $isFurnished, genderPref: $genderPref, timezone: $timezone, isOpen: $isOpen, scheduledTaskNames: $scheduledTaskNames, coverImageBytes: $coverImageBytes, galleryImageBytes: $galleryImageBytes, galleryUrlsToDelete: $galleryUrlsToDelete)';
}
...
@useResult
$Res call({
 Category? category, SubCategory? subCategory, String name, String description, String cityName, String sectorName, String streetAddress, LatLng? latLng, String phoneNumber, String messagingNumber, String email, String facebookUrl, String instagramUrl, String websiteUrl, Map<DayOfWeek, OpeningHours> openingHours, double? pricing, bool isFurnished, GenderPreference genderPref, String timezone, bool isOpen, Map<String, String> scheduledTaskNames, Uint8List? coverImageBytes, List<Uint8List> galleryImageBytes, List<String> galleryUrlsToDelete
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Category? category,  SubCategory? subCategory,  String name,  String description,  String cityName,  String sectorName,  String streetAddress,  LatLng? latLng,  String phoneNumber,  String messagingNumber,  String email,  String facebookUrl,  String instagramUrl,  String websiteUrl,  Map<DayOfWeek, OpeningHours> openingHours,  double? pricing,  bool isFurnished,  GenderPreference genderPref,  String timezone,  bool isOpen,  Map<String, String> scheduledTaskNames,  Uint8List? coverImageBytes,  List<Uint8List> galleryImageBytes,  List<String> galleryUrlsToDelete)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ShopForm() when $default != null:
return $default(_that.category,_that.subCategory,_that.name,_that.description,_that.cityName,_that.sectorName,_that.streetAddress,_that.latLng,_that.phoneNumber,_that.messagingNumber,_that.email,_that.facebookUrl,_that.instagramUrl,_that.websiteUrl,_that.openingHours,_that.pricing,_that.isFurnished,_that.genderPref,_that.timezone,_that.isOpen,_that.scheduledTaskNames,_that.coverImageBytes,_that.galleryImageBytes,_that.galleryUrlsToDelete);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Category? category,  SubCategory? subCategory,  String name,  String description,  String cityName,  String sectorName,  String streetAddress,  LatLng? latLng,  String phoneNumber,  String messagingNumber,  String email,  String facebookUrl,  String instagramUrl,  String websiteUrl,  Map<DayOfWeek, OpeningHours> openingHours,  double? pricing,  bool isFurnished,  GenderPreference genderPref,  String timezone,  bool isOpen,  Map<String, String> scheduledTaskNames,  Uint8List? coverImageBytes,  List<Uint8List> galleryImageBytes,  List<String> galleryUrlsToDelete)  $default,) {final _that = this;
switch (_that) {
case _ShopForm():
return $default(_that.category,_that.subCategory,_that.name,_that.description,_that.cityName,_that.sectorName,_that.streetAddress,_that.latLng,_that.phoneNumber,_that.messagingNumber,_that.email,_that.facebookUrl,_that.instagramUrl,_that.websiteUrl,_that.openingHours,_that.pricing,_that.isFurnished,_that.genderPref,_that.timezone,_that.isOpen,_that.scheduledTaskNames,_that.coverImageBytes,_that.galleryImageBytes,_that.galleryUrlsToDelete);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Category? category,  SubCategory? subCategory,  String name,  String description,  String cityName,  String sectorName,  String streetAddress,  LatLng? latLng,  String phoneNumber,  String messagingNumber,  String email,  String facebookUrl,  String instagramUrl,  String websiteUrl,  Map<DayOfWeek, OpeningHours> openingHours,  double? pricing,  bool isFurnished,  GenderPreference genderPref,  String timezone,  bool isOpen,  Map<String, String> scheduledTaskNames,  Uint8List? coverImageBytes,  List<Uint8List> galleryImageBytes,  List<String> galleryUrlsToDelete)?  $default,) {final _that = this;
switch (_that) {
case _ShopForm() when $default != null:
return $default(_that.category,_that.subCategory,_that.name,_that.description,_that.cityName,_that.sectorName,_that.streetAddress,_that.latLng,_that.phoneNumber,_that.messagingNumber,_that.email,_that.facebookUrl,_that.instagramUrl,_that.websiteUrl,_that.openingHours,_that.pricing,_that.isFurnished,_that.genderPref,_that.timezone,_that.isOpen,_that.scheduledTaskNames,_that.coverImageBytes,_that.galleryImageBytes,_that.galleryUrlsToDelete);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ShopForm&&(identical(other.category, category) || other.category == category)&&(identical(other.subCategory, subCategory) || other.subCategory == subCategory)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.cityName, cityName) || other.cityName == cityName)&&(identical(other.sectorName, sectorName) || other.sectorName == sectorName)&&(identical(other.streetAddress, streetAddress) || other.streetAddress == streetAddress)&&(identical(other.latLng, latLng) || other.latLng == latLng)&&(identical(other.phoneNumber, phoneNumber) || other.phoneNumber == phoneNumber)&&(identical(other.messagingNumber, messagingNumber) || other.messagingNumber == messagingNumber)&&(identical(other.email, email) || other.email == email)&&(identical(other.facebookUrl, facebookUrl) || other.facebookUrl == facebookUrl)&&(identical(other.instagramUrl, instagramUrl) || other.instagramUrl == instagramUrl)&&(identical(other.websiteUrl, websiteUrl) || other.websiteUrl == websiteUrl)&&const DeepCollectionEquality().equals(other._openingHours, _openingHours)&&(identical(other.pricing, pricing) || other.pricing == pricing)&&(identical(other.isFurnished, isFurnished) || other.isFurnished == isFurnished)&&(identical(other.genderPref, genderPref) || other.genderPref == genderPref)&&(identical(other.timezone, timezone) || other.timezone == timezone)&&(identical(other.isOpen, isOpen) || other.isOpen == isOpen)&&const DeepCollectionEquality().equals(other._scheduledTaskNames, _scheduledTaskNames)&&const DeepCollectionEquality().equals(other.coverImageBytes, coverImageBytes)&&const DeepCollectionEquality().equals(other._galleryImageBytes, _galleryImageBytes)&&const DeepCollectionEquality().equals(other._galleryUrlsToDelete, _galleryUrlsToDelete));
}


@override
int get hashCode => Object.hashAll([runtimeType,category,subCategory,name,description,cityName,sectorName,streetAddress,latLng,phoneNumber,messagingNumber,email,facebookUrl,instagramUrl,websiteUrl,const DeepCollectionEquality().hash(_openingHours),pricing,isFurnished,genderPref,timezone,isOpen,const DeepCollectionEquality().hash(_scheduledTaskNames),const DeepCollectionEquality().hash(coverImageBytes),const DeepCollectionEquality().hash(_galleryImageBytes),const DeepCollectionEquality().hash(_galleryUrlsToDelete)]);
