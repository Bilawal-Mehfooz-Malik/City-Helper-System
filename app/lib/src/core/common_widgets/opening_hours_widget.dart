...
//     final hours = widget.entity.when(
//       residence: (residence, _, _, _, _, _, _) => residence.openingHours,
//       food: (food, _, _, _, _, _, _) => food.openingHours,
//     );
//     final isOpen = widget.entity.when(
//       residence: (residence, _, _, _, _, _, _) => residence.isEntityOpen(),
//       food: (food, _, _, _, _, _, _) => food.isEntityOpen(),
//     );
