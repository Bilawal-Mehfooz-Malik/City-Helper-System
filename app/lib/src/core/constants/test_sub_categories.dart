...
final List<SubCategory> testSubCategories = [
  ...
  SubCategory(id: 1, name: "Rooms", categoryId: 1, sortOrder: 1),
  SubCategory(id: 2, name: "Hostels", categoryId: 1, sortOrder: 2),
  SubCategory(id: 3, name: "Flats", categoryId: 1, sortOrder: 3),
  SubCategory(id: 4, name: "Houses", categoryId: 1, sortOrder: 4),
  SubCategory(id: 5, name: "Hotels", categoryId: 1, sortOrder: 5),
